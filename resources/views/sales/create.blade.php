            ...
            <div class="col-lg-8">
                <div class="card p-3">
                    <div class="card-header">
                        <h4 class="card-title bg-dark text-center p-3" style="border-radius: 50px">Add New Sale</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('sales.store') }}">
                            ...
                            <div class="form-group" id="client-selection">
                                <label for="client_id">Product</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="quantity_sold" class="form-control{{ $errors->has('quantity_sold') ? ' is-invalid' : '' }}" value="{{ old('quantity_sold') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="paid_amount" class="form-control{{ $errors->has('paid_amount') ? ' is-invalid' : '' }}" value="{{ old('paid_amount') }}" required>
